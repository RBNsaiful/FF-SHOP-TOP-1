...
const AuthScreen: React.FC<AuthScreenProps> = ({ texts, appName, logoUrl, onDemoLogin }) => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError("Google Login Failed. Try Guest Mode.");
    }
  };
    ...
    <div className="min-h-screen w-full flex flex-col justify-center px-6 relative overflow-hidden bg-light-bg dark:bg-dark-bg transition-colors duration-300">
      ...
      <div className="w-full max-w-md mx-auto z-10">
          ...
          <div className="w-full space-y-3 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
            ...
            <button
              onClick={onDemoLogin}
              className="w-full py-3.5 bg-gray-100 dark:bg-gray-800/50 text-gray-500 dark:text-gray-400 font-bold rounded-2xl flex items-center justify-center gap-2 hover:bg-gray-200 dark:hover:bg-gray-800 transition-all active:scale-95 text-xs uppercase tracking-wide border border-transparent hover:border-gray-300 dark:hover:border-gray-700"
            >
